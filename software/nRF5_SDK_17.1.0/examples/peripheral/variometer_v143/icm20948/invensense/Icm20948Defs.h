...
#define IMU_CHIP  HW_ICM20648
#endif

#if defined USE_ICM20948
#define IMU_CHIP  HW_ICM20948
#endif

#if !defined(IMU_CHIP)
    #error "IMU_CHIP is not defined"
#elif IMU_CHIP != HW_ICM20648 \
        && IMU_CHIP != HW_ICM20948
    #error "Unknown value for IMU_CHIP"
#endif

#define DMP_LOAD_START 0x90
//#define DMP_LOAD_START      (0x90 << 1)
